...
public class UIController : Singleton<UIController>
{
    ...
    [SerializeField] private UIFader m_CheckerUI;                   // This controls fading the UI shown during the checker.
    ...
    public IEnumerator ShowCheckerUI()
    {
        Showing = true;
        yield return StartCoroutine(m_CheckerUI.InteruptAndFadeIn());
    }

    public IEnumerator HideCheckerUI()
    {
        Showing = false;
        yield return StartCoroutine(m_CheckerUI.InteruptAndFadeOut());
    }
