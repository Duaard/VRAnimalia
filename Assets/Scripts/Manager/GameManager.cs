...
public class GameManager : Singleton<GameManager>
{
    ...
    private IEnumerator Start()
    {
        ...
        if(DataHandler.IsAlreadyGotoPhylums < 9)
        {
            yield return StartCoroutine(CheckPhase());
        }
        while (true)
        {
    ...
    {
        // Wait for the checker UI to fade in.
        yield return StartCoroutine(UIController.Instance.ShowCheckerUI());
        ...
        // Wait for the checker UI to fade out.
        yield return StartCoroutine(UIController.Instance.HideCheckerUI());
    }
